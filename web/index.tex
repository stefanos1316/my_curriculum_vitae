...
\startblockquote
{\bf NOTE}: Please use the online CV
(https://stefanos1316.github.io/my_curriculum_vitae/) because some fonts
and pictures are not printed in the PDF format
\stopblockquote
...
\item
  ...
  \item
    ...
    {[}\useURL[url14][][][BibTex]\from[url14]{]}
  \item
...
\startdescription{Research}
  ...
  \useURL[url29][perccom_summer_school_2018.pdf][][Proof]\from[url29]
\stopdescription
...
{[}\useURL[url30][https://github.com/AUEB-BALab/courses][][Repository]\from[url30]{]}

Gave Java lectures and tutorials for the 1st and 2nd Coding Boot Camp in
Athens, Greece (Oct.~2017 - May 2018)
{[}\useURL[url31][https://github.com/codeandwork/courses][][Repository]\from[url31]{]}
{[}\useURL[url32][boot_camp_athens_2016_2017.pdf][][Proof]\from[url32]{]}

\subsection[title={Industrial
Experience},reference={industrial-experience}]

\startdescription{Sep 2020-current}
  {\bf Software Developer} \useURL[url33][https://gfoss.eu/][][Greek
  Free, Open Source Software]\from[url33]

  Developing a privacy-preserving epidemic dosimeter based on contact
  tracing. \useURL[url34][gfoss_2020.pdf][][Proof]\from[url34]
  \useURL[url35][https://github.com/eellak/epidose.git][][Repository]\from[url35]

  \startdescription{{\em Responsibilities}}
    Developing
    \useURL[url36][https://www.python.org/][][Python]\from[url36],
    \useURL[url37][https://www.gnu.org/software/bash/][][Shell]\from[url37],
    and \useURL[url38][https://www.ansible.com/][][Ansible]\from[url38]
...
\startdescription{Jan 2019-Apr 2020}
  ...
  \useURL[url39][https://www.allcancode.com/][][AllCanCode Inc.~Greek
  Branch]\from[url39]

  Supported the product development that facilitates fast web-sites
  development (by using
  \useURL[url40][https://developers.google.com/blockly][][Blockly]\from[url40])
  on Desktop that can be exported in smart-phones as well.

  \startdescription{{\em Responsibilities}}
    Development of API end-points in JavaScript
    (\useURL[url41][https://nodejs.org/en/][][Node.JS]\from[url41]) and
    \useURL[url42][https://www.mongodb.com/][][MongoDB]\from[url42] for
    ...
    \useURL[url43][https://mochajs.org/][][Mocha]\from[url43] and
    \useURL[url44][https://www.cypress.io/][][Cypress]\from[url44]
    ...
    \useURL[url45][https://cloud.google.com/appengine/docs/flexible][][Flex
    environment]\from[url45]

    Migration of monolithic product to micro-services using
    \useURL[url46][https://firebase.google.com/docs/hosting][][Firebase
    hosting]\from[url46],
    \useURL[url47][https://firebase.google.com/docs/functions][][Cloud
    Functions]\from[url47], and
    \useURL[url48][https://cloud.google.com/run][][Cloud
    Run]\from[url48]

    Integration of
    \useURL[url49][https://www.bitrise.io/][][Bitrise]\from[url49]
    ...
    \useURL[url50][https://cordova.apache.org/][][Cordova]\from[url50]
    wrapper
  \stopdescription
\stopdescription
...
\startdescription{Jan 2016-2019}
  ...
  \useURL[url51][https://portal.singularlogic.eu/en][][Singular Logic
  S.A.]\from[url51]

  Proposals writing for the European Projects Department.
  \useURL[url52][singular_logic_2016-2019.pdf][][Proof]\from[url52]
...
\startdescription{{\em Back-End}}
  ...
  MongoDB (\useURL[url53][mongodb_m001,pdf][][Basics]\from[url53],
  \useURL[url54][mongodb_m121.pdf][][Aggregations]\from[url54],
  \useURL[url55][mongodb_m220.pdf][][JavaScript]\from[url55], and
  \useURL[url56][mongodb_m201.pdf][][Performance]\from[url56])
\stopdescription
...
\startdescription{{\em Projects}}
  ...
  tracing
  \useURL[url57][https://github.com/eellak/epidose][][Repository]\from[url57]

  Exam Questionnaire Scanner:
  \useURL[url58][https://github.com/AntonisGkortzis/ExamQuestionnaireScanner][][Repository]\from[url58]

  Measuring Energy Consumption:
  \useURL[url59][https://github.com/stefanos1316/SEMTs_Comparisson][][Software]\from[url59]
  and
  \useURL[url60][https://stefanos1316.github.io/courses/tools/measuring_energy_consumption_direct_approach-p.html\#/][][Hardware]\from[url60]
  tools

  Programming II website:
  \useURL[url61][https://github.com/stefanos1316/courses][][Repository]\from[url61]

  Rosetta Code Experiement:
  \useURL[url62][https://github.com/stefanos1316/Rosetta_Code_Data_Set][][Repository]\from[url62]

  Validate Links:
  \useURL[url63][https://github.com/stefanos1316/validateLinks][][Repository]\from[url63]
\stopdescription

\startdescription{{\em Certificates}}
  Unix Tools: \useURL[url64][unix_tools_edx.pdf][][Data, Software, and
  Production Engineering]\from[url64]
\stopdescription

\startdescription{{\em Course Completion}}
  MongoDB: \useURL[url65][mongodb_m001.pdf][][Basics]\from[url65],
  \useURL[url66][mongodb_m121.pdf][][Aggregation]\from[url66],
  \useURL[url67][mongodb_m220.pdf][][JavaScript]\from[url67], and
  \useURL[url68][mongodb_m201.pdf][][Performance]\from[url68]
\stopdescription
...
\item
  ...
  \startitemize[packed]
  \item
    \useURL[url69][arctic_code_contributor.jpg][][Arctic Code Vault
    Contributor]\from[url69]
  \item
    Mentored younger researcher \useURL[url70][fse19.pdf][][who won 2nd
    place]\from[url70] in SRC ESEC/FSE '19.
  \item
    Best paper award from the 15th Annual DMST Student Conference (2018)
  \item
    Marie Skłodowska-Curie funds,
    \useURL[url71][https://portal.singularlogic.eu/en/eu-project/12374/seneca][][SENECA]\from[url71]
    (2016-2019)
  \item
